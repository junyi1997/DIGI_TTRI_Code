...
void setNumber(int number)
{
  ...
  setDigit(1, n1); digitalWrite(PIN_h, HIGH);delay(5);
  setDigit(2, n2); delay(5);
  setDigit(3, n3); digitalWrite(PIN_h, HIGH);delay(5);
}
...
void loop() {
  ...
  if(time_now - time_previous > 1000){
    ...
    if(volt<0.02){delay(1);R_2=0000;}//Serial.println("Max_Error")
    else if(volt>3.2){delay(1);R_2=0000;}//Serial.println("Min_Error")  
    else
    { 
