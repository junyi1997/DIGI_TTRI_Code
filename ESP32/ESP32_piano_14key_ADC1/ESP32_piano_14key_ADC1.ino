...
{
  for(int j = 0 ; j < k ; j++){
    for(int i = 0 ; i < 7 ; i++){//讀取ADC01值
      ADC_V0[i]+=analogRead(pinADC[i]);
    }
    //讀取ADC02值
    int read_ADC2_1;int read_ADC2_2;int read_ADC2_3;int read_ADC2_4;
    int read_ADC2_5;int read_ADC2_6;int read_ADC2_7;int read_ADC2_8;
    adc2_config_channel_atten( ADC2_CHANNEL_8, ADC_ATTEN_6db );
    esp_err_t r = adc2_get_raw( ADC2_CHANNEL_8, ADC_WIDTH_12Bit, &read_ADC2_1);
    adc2_config_channel_atten( ADC2_CHANNEL_9, ADC_ATTEN_6db );
    esp_err_t r1 = adc2_get_raw( ADC2_CHANNEL_9, ADC_WIDTH_12Bit, &read_ADC2_2); 
    adc2_config_channel_atten( ADC2_CHANNEL_7, ADC_ATTEN_6db );
    esp_err_t r2 = adc2_get_raw( ADC2_CHANNEL_7, ADC_WIDTH_12Bit, &read_ADC2_3); 
    adc2_config_channel_atten( ADC2_CHANNEL_6, ADC_ATTEN_6db );
    esp_err_t r3 = adc2_get_raw( ADC2_CHANNEL_6, ADC_WIDTH_12Bit, &read_ADC2_4); 
    adc2_config_channel_atten( ADC2_CHANNEL_5, ADC_ATTEN_6db );
    esp_err_t r4 = adc2_get_raw( ADC2_CHANNEL_5, ADC_WIDTH_12Bit, &read_ADC2_5); 
    adc2_config_channel_atten( ADC2_CHANNEL_4, ADC_ATTEN_6db );
    esp_err_t r5 = adc2_get_raw( ADC2_CHANNEL_4, ADC_WIDTH_12Bit, &read_ADC2_6); 
    adc2_config_channel_atten( ADC2_CHANNEL_0, ADC_ATTEN_6db );
    esp_err_t r6 = adc2_get_raw( ADC2_CHANNEL_0, ADC_WIDTH_12Bit, &read_ADC2_7); 
    adc2_config_channel_atten( ADC2_CHANNEL_3, ADC_ATTEN_6db );
    esp_err_t r7 = adc2_get_raw( ADC2_CHANNEL_3, ADC_WIDTH_12Bit, &read_ADC2_8); 
    
    ADC_V0[6]+=read_ADC2_1;
    ADC_V0[7]+=read_ADC2_2;
    ADC_V0[8]+=read_ADC2_3;
    ADC_V0[9]+=read_ADC2_4;
    ADC_V0[10]+=read_ADC2_5;
    ADC_V0[11]+=read_ADC2_6;
    ADC_V0[12]+=read_ADC2_7;
    ADC_V0[13]+=read_ADC2_8;
